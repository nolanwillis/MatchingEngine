...
TEST_F(LimitOrderTests, AddedProperlyWithNoFills)
{
	...
	std::unique_ptr<Order>buyOrder2 = 
		std::make_unique<Order>(Stock::Symbol::AAA, 200, 50, 1, 1, Order::Type::Limit);
	std::unique_ptr<Order>buyOrder3 = 
		std::make_unique<Order>(Stock::Symbol::AAA, 300, 50, 2, 1, Order::Type::Limit);
	std::unique_ptr<Order>buyOrder4 = 
		std::make_unique<Order>(Stock::Symbol::AAA, 400, 50, 3, 1, Order::Type::Limit);
	std::unique_ptr<Order>buyOrder5 = 
		std::make_unique<Order>(Stock::Symbol::AAA, 500, 50, 4, 1, Order::Type::Limit);

	std::unique_ptr<Order>sellOrder1 = 
		std::make_unique<Order>(Stock::Symbol::AAA, 600, 50, 5, 0, Order::Type::Limit);
	std::unique_ptr<Order>sellOrder2 = 
		std::make_unique<Order>(Stock::Symbol::AAA, 700, 50, 6, 0, Order::Type::Limit);
	std::unique_ptr<Order>sellOrder3 = 
		std::make_unique<Order>(Stock::Symbol::AAA, 800, 50, 7, 0, Order::Type::Limit);
	std::unique_ptr<Order>sellOrder4 = 
		std::make_unique<Order>(Stock::Symbol::AAA, 900, 50, 8, 0, Order::Type::Limit);
	std::unique_ptr<Order>sellOrder5 = 
		std::make_unique<Order>(Stock::Symbol::AAA, 1000, 50, 9, 0, Order::Type::Limit);
...
TEST_F(LimitOrderTests, AddedProperlyWithPartialFills)
{
	std::unique_ptr<Order>buyOrder1 = 
		std::make_unique<Order>(Stock::Symbol::AAA, 100, 50, 0, 1, Order::Type::Limit);
	std::unique_ptr<Order>buyOrder2 = 
		std::make_unique<Order>(Stock::Symbol::AAA, 75, 100, 1, 1, Order::Type::Limit);

	std::unique_ptr<Order>sellOrder1 = 
		std::make_unique<Order>(Stock::Symbol::AAA, 100, 100, 2, 0, Order::Type::Limit);
	std::unique_ptr<Order>sellOrder2 = 
		std::make_unique<Order>(Stock::Symbol::AAA, 75, 50, 3, 0, Order::Type::Limit);
...
TEST_F(LimitOrderTests, AddedProperlyWithFullFills)
{
	std::unique_ptr<Order>buyOrder1 = 
		std::make_unique<Order>(Stock::Symbol::AAA, 100, 50, 0, 1, Order::Type::Limit);
	std::unique_ptr<Order>buyOrder2 = 
		std::make_unique<Order>(Stock::Symbol::AAA, 75, 50, 1, 1, Order::Type::Limit);

	std::unique_ptr<Order>sellOrder1 = 
		std::make_unique<Order>(Stock::Symbol::AAA, 100, 50, 2, 0, Order::Type::Limit);
	std::unique_ptr<Order>sellOrder2 = 
		std::make_unique<Order>(Stock::Symbol::AAA, 75, 50, 3, 0, Order::Type::Limit);
